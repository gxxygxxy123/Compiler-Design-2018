...
struct Entry {
	...
	Entry *next;
	bool def;
	int local_index;	// index of this variable/parameter/constant..
};
struct Type{
...
struct id_struct{
	...
	int local_index; // index of the variable/constant
};
struct Expr{
	Type *type;
	Entry *e;
...
idList* AddToidList(Table *, idList*, const char*, TypeDim*, Attribute*);
FuncParamidList* AddToFuncParamidList(Table *, FuncParamidList*, const char*, Type*);
